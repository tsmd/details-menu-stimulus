...
app.register("details-menu", DetailsMenu);

describe("details-menu controller", function () {
  describe("after tree insertion", function () {
    beforeEach(function () {
      ...
      container.innerHTML = `
        <details>
          ...
          <div data-controller="details-menu">
    ...
    it("has default attributes set", function () {
      ...
      const menu = details.querySelector("[data-controller='details-menu']");
    ...
    it("opens and does not focus an item on mouse click", function () {
      ...
      assert.equal(
        ...
        "mouse toggle open leaves summary focused"
      );
    });
    ...
    it("opens and focuses first item on summary enter", function () {
      ...
      assert.equal(
        first,
        document.activeElement,
        "toggle open focuses first item"
      );
    });
    ...
    it("opens and focuses last item on arrow up", function () {
      ...
      const last = [
        ...details.querySelectorAll(
          '[role="menuitem"]:not([disabled]):not([aria-disabled])'
        ),
      ].pop();
    ...
    it("navigates items with arrow keys", function () {
      ...
      const [first, second, rest] = details.querySelectorAll(
        '[role="menuitem"]'
      );
      assert(rest);
    ...
    it("does not trigger aria-disabled item", function () {
      ...
      assert.equal(
        notDisabled,
        document.activeElement,
        "arrow focuses on the last non-disabled item"
      );
  ...
  describe("with no valid menu items", function () {
    ...
    it("focus stays on summary", function () {
      ...
      assert.equal(
        summary,
        document.activeElement,
        "summary remains focused on toggle"
      );
      ...
      assert.equal(
        summary,
        document.activeElement,
        "summary remains focused on navigation"
      );
    });
  });
        ...
        <details class="parent">
          ...
          <div data-controller="details-menu">
            <details class="nested">
              ...
              <div data-controller="details-menu"></div>
            </details>
          </details-menu>
        </details>
  ...
  describe("with input[autofocus]", function () {
    beforeEach(function () {
      ...
      container.innerHTML = `
        <details>
          <summary>Menu 1</summary>
          <div data-controller="details-menu" role="none">
            <input autofocus>
            <div role="menu">
    ...
    it("autofocuses on input on keyboard activation", function () {
      ...
      assert.equal(
        input,
        document.activeElement,
        "toggle open focuses on [autofocus]"
      );
    });
  });
